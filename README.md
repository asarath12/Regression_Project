...
## 📟 Example Terminal Output (tasks.py)

Below is output generated by `tasks.py`:

![Tasks Output](./images/out_1.png)

![Tasks Output](./images/out_2.png)

![Tasks Output](./images/out_3.png)

![Tasks Output](./images/out_4.png)

![Tasks Output](./images/out_5.png)

![Tasks Output](./images/out_6.png)

![Tasks Output](./images/out_7.png)

![Tasks Output](./images/out_8.png)

![Tasks Output](./images/out_9.png)

![Tasks Output](./images/out_10.png)

![Tasks Output](./images/out_11.png)

---

### 📌 Example Outputs (Visualizations.py)
